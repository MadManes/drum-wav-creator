...
sounds = {
    'crash 1': load_sound('crash_1.wav', 0.5),
    'crash 2': load_sound('crash_2.wav', 0.7),
    'cowbell': load_sound('cowbell.wav', 0.8),
    'Op. hihat': load_sound('op_hihat.wav', 0.5),
    'H. tom': load_sound('h_tom.wav', 1.4),
    'snare': load_sound('snare.wav', 1.3),
    'F. tom': load_sound('f_tom.wav', 1.5),
    'kick': load_sound('kick.wav', 1.5),
    'F. hihat': load_sound('f_hihat.wav', 0.8)
}
...
class DrumGUI:
    ...
    def handle_click(self, pos):
        ...
        ## MANEJO CLICK EN PLAY/STOP
        elif self.play_btn.collidepoint(pos):
            if self.engine.playing:
                self.engine.stop()
            else:
                self.engine.start()
        ## ## MANEJO CLICK EN POPUPS SOLO CUANDO HAY UN POPUP ACTIVO        
        ...
        ## MANEJO CLICK EN INPUTS BEATS Y SUBDIVISIONS
